...
public class Notification extends Driver {
	...
	public String BalanceCheck() {
		...
		try {
			...
			SetCapabilities.dr.findElement(By.xpath("//*[@class='android.widget.TextView' and @text='Vodafone']")).click();
			WebElement message = SetCapabilities.dr.findElementById("com.google.android.apps.messaging:id/message_text");
			MSG=SetCapabilities.dr.findElementById("com.google.android.apps.messaging:id/message_text").getText();
			utils.takeScreenShot();
			SetCapabilities.dr.findElement(By.xpath("//*[@class='android.widget.ImageView' and @content-desc='More options']")).click();
			SetCapabilities.dr.findElement(By.xpath("//*[@class='android.widget.TextView' and @text='Delete']")).click();
	...
	public String FlexBalanceCheck() {
		...
		try {
			SetCapabilities.dr.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
			SetCapabilities.dr.findElement(By.xpath("//*[@class='android.widget.TextView' and @text='Vodafone Customer Care']")).click();
			WebElement message = SetCapabilities.dr.findElementById("com.google.android.apps.messaging:id/message_text");
			MSG=SetCapabilities.dr.findElementById("com.google.android.apps.messaging:id/message_text").getText();
			utils.takeScreenShot();
			SetCapabilities.dr.findElement(By.xpath("//*[@class='android.widget.ImageView' and @content-desc='More options']")).click();
