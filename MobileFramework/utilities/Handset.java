...
public class Handset extends Driver{
	...
	public String ConfigureSMSC() {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@class='android.widget.TextView' and @text='Phone information']")));
			SetCapabilities.dr.findElement(By.xpath("//*[@class='android.widget.TextView' and @text='Phone information']")).click();
			Thread.sleep(2000);
